...
export const MenuItems: any = [
  ...
  { icon: DashboardIcon, badgetxt: "", title: "Dashboards", type: "sub", active: false, selected: false,
    children: [
      { path: "/dashboards/sales", type: "link", active: true, selected: true, dirchange: false,  title: "Sales"},
      { path: "/dashboards/pricing", type: "link", active: false, selected: false, dirchange: false,  title: "Subscription"},
      { path: "/dashboards/call-logs", type: "link", active: false, selected: false, dirchange: false,  title: "Call Logs"},
    ],
  },
